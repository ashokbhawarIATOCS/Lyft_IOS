...
var selectedLanguage : Language = Language(rawValue: UserDefaults.standard.value(forKey: klanguage) as? String ?? "en") ?? .english
var currentBundle : Bundle!

//Function for the country code handling with the mobile code
...
//function for check the number in the textfield start
func checkForStringStartWithNoOrText(text: String) -> Bool
{
    return CharacterSet.decimalDigits.isSuperset(of: CharacterSet(charactersIn: (text)))
}

//Function for remove the view from the textfileld
